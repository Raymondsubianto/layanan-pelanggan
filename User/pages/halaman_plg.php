...
<head>
  ...
  <title>UP3 | <?php echo $username?></title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="halaman_plg.php" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="penggunaan_daya.php?op=edit" class="nav-link">
          ...
          <div class="col-lg-3 col-6" style="margin-top:50px">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <p>Informasi <?php echo $username?></p>
              </div>
