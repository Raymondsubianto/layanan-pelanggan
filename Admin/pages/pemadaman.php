...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($waktu && $lokasi && $estimasi) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update tb_pemadaman set waktu = '$waktu',estimasi = '$estimasi',lokasi = '$lokasi' where id_pemadaman = '$id_pemadaman'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into tb_pemadaman (id_pemadaman,waktu,estimasi,lokasi) values ('','$waktu','$estimasi','$lokasi')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php
                header("refresh:2;url=pemadaman.php");
                }
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3 row">
                        <label for="estimasi" class="col-sm-2 col-form-label">Estimasi (Jam)</label>
                        <div class="col-sm-10">
                        <!-- <input type="text" class="form-control" id="estimasi" name="estimasi" "> -->
                            <input class="form-control" name="estimasi" id="estimasi" value="<?php echo $estimasi ?>">
                        </div>
                    </div>
                    <div class="col-12">
    ...
    ?>
        <tr>
            ...
            <td scope="row">
                <a href="pemadaman.php?op=edit&id_pemadaman=<?php echo $id_pemadaman?>"><button type="button" class="btn btn-warning">Edit</button></a>
                <a href="pemadaman.php?op=delete&id_pemadaman=<?php echo $id_pemadaman?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>            
            </td>
        </tr>
    <?php
    }
