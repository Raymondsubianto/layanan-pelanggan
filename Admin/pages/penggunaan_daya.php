        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                    <?php
    $sql = "select tb_bulanan.bulan, tb_bulanan.pemakaian, tb_plg.nama, tb_bulanan.id_bulanan
            from tb_bulanan, tb_plg 
            where tb_bulanan.username=tb_plg.username order by tb_plg.nama";
